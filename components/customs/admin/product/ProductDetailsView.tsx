...
export default function ProductDetailsView({
  ...
  const fullName = activeDetail.name || "Product Specs";
        ...
        <div className="p-6 space-y-6">
          ...
          {activeDetail.images && activeDetail.images.length > 0 && (
            <div className="relative h-56 rounded-2xl overflow-hidden border border-stone-200/30 dark:border-stone-800/30">
              ...
              />
              <span className="absolute bottom-4 left-4 text-[10px] font-bold text-white bg-stone-955/60 px-3 py-1 rounded-xl backdrop-blur-md">
                Base SKU Model
              </span>
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-xl bg-stone-50 dark:bg-stone-955/40 border border-stone-200/40 dark:border-stone-800/20 space-y-2 text-stone-600 dark:text-stone-400 font-semibold">
                <div className="flex justify-between">
                  <span>Weight:</span>
                  <span className="text-stone-900 dark:text-stone-100">
          ...
          <div className="space-y-4">
            <h4 className="text-[10px] font-bold text-stone-400 dark:text-stone-505 uppercase tracking-widest border-b border-stone-200/40 dark:border-stone-800/40 pb-1">
              System & Guarantee Specifications
            </h4>
            <div className="p-4 rounded-xl bg-stone-50 dark:bg-stone-950/40 border border-stone-200/40 dark:border-stone-800/20 space-y-2 text-stone-600 dark:text-stone-400 font-semibold">
              <div className="flex justify-between">
